...
class Mine extends Component {
    ...
    async shareToWechat(data) {
        ...
        let result =  await GetBasicInfo.isWechatInstall();
        if (result == "fail") {Alert.alert("邀请失败，请先安装微信！");return;}
            ...
            <View style = {styles.rootView}>
                ...
                >
                    <ShareWindow
                        ...
                        checkBoxClickHandle = {()=>{this.setState({isCouponCheck:!this.state.isCouponCheck})}}
                ...
                <ScrollView>
                    ...
                    <ButtonBar
                        ...
                        title = {'我的订单'}
                        introduction = {'全部订单'}
                        onPress = {() => { Actions.MyOrder({ handleId: 1 })}}
                    />

                    <View style = {[styles.moneyBarView, {marginTop: 1, borderBottomColor: '#dddddd', borderBottomWidth: 1}]}>
                        <ClickScope onPress = {() => { Actions.MyOrder({ handleId: 2 })}}
                        ...
                        <ClickScope onPress = {() => { Actions.MyOrder({ handleId: 3 })}}
                            style = {styles.moneyBarItemView}
                        >
                            <Image
                        ...
                        <ClickScope onPress = {() => { Actions.MyOrder({ handleId: 4 })}}
                            style = {styles.moneyBarItemView}
                        >
                            <Image
                        ...
                        <ClickScope onPress = {() => { Actions.MyOrder({ handleId: 5 })}}
                            style = {styles.moneyBarItemView}
                        >
                            <Image
                                style = {{width: 27, height: 20}}
