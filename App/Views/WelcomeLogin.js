...
export default class WelcomeLogin extends Component {
    ...
    componentDidMount() {
        ...
        NativeAppEventEmitter.addListener('WX_LOGIN_SUCCESS', (params) => {
            ...
            //登录获取jsonid
            that.requestAppStart().then(data => {
                ...
                console.log('app_start failure');
            });
            console.log('requestAppStart eeee');
        });
            ...
            Request('/index/login/app_start', "POST", "")
                .then((data) => {
                    ...
                    if (0 == data.errno) {
                        ...
                        resolve(data.data.JSSIONID);
                    }
                }, (error) => {
                    console.log('requestAppStart '+error);
                    reject(false);
                });
        })
    }
